...
public interface AccountsApi {
    ...
    @RequestMapping(value = "/accounts",
            produces = { "application/json" },
            method = RequestMethod.GET)
    ResponseEntity<List<AccountResponseDTO>> getAccounts( @Parameter(in = ParameterIn.QUERY, description = "skip the needed amount of accounts" ,required=false,schema=@Schema()) @Valid @RequestParam(value = "skip", required = false) Integer skip,
